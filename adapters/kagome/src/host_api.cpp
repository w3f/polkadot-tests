...
namespace host_api {
  ...
  void processCommand(const CommandArgs &args) {
    SubcommandRouter<helpers::RuntimeEnvironment &,
        ...
        router({
            ...
            {"ext_storage_clear_prefix_version_1",
             storage::clear_prefix_version_1},
            ...
            {"ext_default_child_storage_set_version_1",
             child_storage::set_get_version_1},
            {"ext_default_child_storage_get_version_1",
             child_storage::set_get_version_1},
            {"ext_default_child_storage_read_version_1",
             child_storage::read_version_1},
            {"ext_default_child_storage_clear_version_1",
             child_storage::clear_version_1},
            {"ext_default_child_storage_storage_kill_version_1",
             child_storage::storage_kill_version_1},
            {"ext_default_child_storage_exists_version_1",
             child_storage::exists_version_1},
            {"ext_default_child_storage_clear_prefix_version_1",
             child_storage::clear_prefix_version_1},
            {"ext_default_child_storage_root_version_1",
             child_storage::root_version_1},
            {"ext_default_child_storage_next_key_version_1",
             child_storage::next_key_version_1},
            // test crypto ed25519 api
            {"ext_crypto_ed25519_public_keys_version_1",
             crypto::ed25519_public_keys_version_1},
            {"ext_crypto_ed25519_generate_version_1",
             crypto::ed25519_generate_version_1},
            {"ext_crypto_ed25519_sign_version_1",
             crypto::ed25519_sign_version_1},
            {"ext_crypto_ed25519_verify_version_1",
             crypto::ed25519_verify_version_1},
            // test crypto sr25519 api
            {"ext_crypto_sr25519_public_keys_version_1",
             crypto::sr25519_public_keys_version_1},
            {"ext_crypto_sr25519_generate_version_1",
             crypto::sr25519_generate_version_1},
            {"ext_crypto_sr25519_sign_version_1",
             crypto::sr25519_sign_version_1},
            {"ext_crypto_sr25519_verify_version_1",
             crypto::sr25519_verify_version_1},
            // test hashing api
